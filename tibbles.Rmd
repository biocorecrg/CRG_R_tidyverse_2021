...
When you display a tibble, note that there is a 3 or 4-letter abbreviation under each column name: these describe the type of each variable:
...
# Note: with using simple square brackets, you extract a sub-tibble (it remains a 2 dimensional object)
mytibble["letters"]
```
