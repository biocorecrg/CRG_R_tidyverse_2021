...
If we are only interested in the final **tidy** data frame (and not in the intermediate objects `patients2` and `patients3`), there is a **simpler** and **cleaner** way: <br>
