...
1. Download [this file](https://public-docs.crg.es/biocore/projects/training/R_tidyverse_2021/modified_storms.csv) (using a `tidyverse` function!):
  * read in and **tidy** the tibble.
2. What storm has the highest median wind speed?
3. Calculate how many storms happen each year: check what the `distinct` function can do! You might need to `separate` a column...
